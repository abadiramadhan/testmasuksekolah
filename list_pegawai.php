                        ...
                        <div class="ibox-content">
                            ...
                            <table class="table table-striped table-bordered table-hover " id="editable" >
						            ...
						            <?php
						            	...
						            	$sqlSelect2="SELECT * FROM t_pegawai";
						            	...
						            	while($row=mysqli_fetch_array($result)){
                                            ...
                                            echo"<td>$row[1]</td>";
                                            echo"<td>$row[2]</td>";
                                            echo"<td><a href='update_pegawai.php?nip=$row[0]' class='label label-warning'>Update</a> | <a class='label label-danger' href=\"hapus_pegawai.php?id=$row[0]\"onclick=\" return konfirmasi('".$row[0]."')\">
                                            Hapus</a></td>";
						            		echo"</tr>";
						            		$no++;
						            	}
