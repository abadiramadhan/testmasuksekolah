...
<body class="gray-bg" onload="noBacklog();"
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <h3>Selamat Datang Di SISUO <br>(Sistem Informasi Ujian Online) </h3>
            <a href="daftar.php"><p>Belum Punya Akun ? Daftar!</p></a>
            ...
            <p class="m-t"> <small>Inspinia ; SISUO (Sistem Informasi Ujian Online) &copy; 2018</small> </p>
        </div>              
   <!--  </div> -->
