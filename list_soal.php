                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                           	<h3><a href="#">LIST SOAL (JURUSAN)</a></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover " id="editable" >
						            ...
						            <?php
						            	...
						            	$sqlSelect2="SELECT * FROM t_jurusan ";
						            	$result=mysqli_query($koneksi,$sqlSelect2)or die(mysqli_error($koneksi));
						            	while($row=mysqli_fetch_array($result)){
						            		echo"<tr>";
						            		echo"<td>$no</td>";
						            		echo"<td>$row[1]</td>";
						            		echo"<td><a href='lihat_soal.php?kode_jurusan=$row[0]' class='label label-warning'>Lihat Soal</a></td>";
                                            echo"<td><a href='tambah_soal.php?kode_jurusan=$row[0]' class='label label-success'>Tambah Soal</a></td>";
						            		echo"</tr>";
						            		$no++;
						            	}
						            ?>
